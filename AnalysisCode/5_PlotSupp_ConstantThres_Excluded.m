% Constant thresholding - Supplemental Figure for Excluded participants Stage 2
...
% In main folder save PlotSupp_ConstantThres_Excluded.m (this is the master script)
% Create functions folder and save:
% 1. fitPsycheCurveLogit.m
% Download data into a data folder "Excluded_ConstThres" from OSF
...
addpath(genpath('INSERT PATH WHERE SCRIPT SAVED/Excluded_ConstThres')); %path to data folder
...
for s=1:nSubs
    ...
    for r=1:Cruns
        filename=['S',int2str(subs(s)), '_', int2str(r), '.mat']; %
        load(filename);
...
x_label_names = {'','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','Motion Coherence(%)','Motion Coherence(%)','Motion Coherence(%)','Motion Coherence(%)','Motion Coherence(%)'};
y_label_names = {'Accuracy','','','','','Accuracy','','','','','Accuracy','','','','','Accuracy','','','','','Accuracy','','','','','Accuracy','','','','','Accuracy','','','','','Accuracy','','','','','Accuracy','','','',''};


    AppC2Left_exc=figure;
...
% print(f_name,'AppC2Left_exc','-dpdf','-r0')
% print(f_name,'AppC2Left_exc','-dsvg','-r0')
