...
y = nanstd(x,0,dim)./sqrt(count);
%alteration from Petra: 0 added between x and dim
%nanstd needs 3 arguments if dim shall be referred to
%the 2nd argument is the flag(set to 0) and only the 3rd is dim
